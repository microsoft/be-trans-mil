...
#  -------------------------------------------------------------------------------------------
"""
This script can be used to estimate the brown stain percentage in tiles of a slide. It can be run locally or on AzureML.

For a full documentation of the parameters, run `python cyted/analysis/tiles_brown_stain_ratio.py --help`
"""
...
from cyted.analysis.analysis_configs import BrownStainTilesConfig  # noqa: E402
from health_azure.logging import logging_to_stdout  # noqa: E402
from health_azure.argparsing import parse_arguments, create_argparser, apply_overrides  # noqa: E402


def create_brown_stain_ratio_argparser() -> ArgumentParser:
    """Creates the argument parser for estimating brown stain ratio in tiles."""
    return create_argparser(
        BrownStainTilesConfig(),
        usage="python cyted/analysis/tile_brown_stain_ratio.py --dataset <dataset> --dataset_csv <dataset_csv>"
...
def create_config_from_args() -> BrownStainTilesConfig:
    """Creates the config for estimating brown stain ratio in tiles from the command line arguments."""
